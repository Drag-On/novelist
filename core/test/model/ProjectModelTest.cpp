...
TEST_CASE("ProjectModel data storage", "[Model]")
{
    ...
    SECTION("insertion")
    {
        ...
        SECTION("Top level")
        {
            ...
            std::string insertedDisplay = model.data(model.projectRootIndex().child(0, 0), Qt::DisplayRole).toString().toStdString();
        ...
        SECTION("nested")
        {
            ...
            insertedDisplay = model.data(model.projectRootIndex().child(0, 0).child(0, 0), Qt::DisplayRole).toString().toStdString();
    ...
    SECTION("Move")
    {
        ...
        {
            REQUIRE(model.moveRows(model.projectRootIndex().child(0, 0), 1, 1, model.projectRootIndex().child(0, 0), 0));
            std::string display = model.data(model.projectRootIndex().child(0, 0).child(0, 0), Qt::DisplayRole).toString().toStdString();
            std::string correct = defaultNodes[{0,0,1}].first;
            REQUIRE(display == correct);
            display = model.data(model.projectRootIndex().child(0, 0).child(1, 0), Qt::DisplayRole).toString().toStdString();
        ...
        {
            REQUIRE(model.moveRows(model.projectRootIndex().child(0, 0).child(1,0), 0, 1, model.projectRootIndex().child(0, 0), 1));
            std::string display = model.data(model.projectRootIndex().child(0, 0).child(1, 0), Qt::DisplayRole).toString().toStdString();
        ...
        {
            REQUIRE(model.moveRows(model.projectRootIndex().child(0, 0), 0, 1, model.projectRootIndex().child(0, 0).child(1, 0), 0));
            std::string display = model.data(model.projectRootIndex().child(0, 0).child(0, 0).child(0, 0), Qt::DisplayRole).toString().toStdString();
